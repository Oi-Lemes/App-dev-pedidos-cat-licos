...
export default function CertificadoPage() {
  ...
  // Se o curso ESTÁ concluído, mas o usuário NÃO TEM acesso (não é Ultra, não é Premium e não comprou) E SEM BYPASS
  if (!user?.hasWalletAccess && user?.plan !== 'ultra' && user?.plan !== 'premium' && cursoConcluido && !IS_DEV_BYPASS) {
    return (
      <section className="flex flex-col items-center justify-center h-full text-center p-6">
